...
export default function CTASection() {
  return (
    <section className="py-24 px-6 bg-brand-dark text-white relative overflow-hidden w-full">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10 space-y-8">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-8">
          <Button size="lg" className="bg-brand-light text-brand-dark hover:bg-white w-full sm:w-auto">
            Contact Us Now
          </Button>
          <Button size="lg" variant="outline" className="border-brand-light text-brand-light hover:bg-brand-light hover:text-brand-dark w-full sm:w-auto">
            WhatsApp Us
          </Button>
        </div>
      </div>
